...
public:
	...
	UPROPERTY(config, EditAnywhere, AdvancedDisplay, Category = "Save and Load", meta = (UIMin=1, ClampMin=1, DisplayName = "Deferred Load Size", EditCondition = "LoadMethod == ELoadMethod::LM_Deferred"))
...
public:
	...
	static FORCEINLINE const UEMSPluginSettings* Get()
	{
